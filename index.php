...
<div id="wpf-loader-two">
  <div class="wpf-loader-two-inner"> <span>.....</span> </div>
</div>
<!-- / wpf loader Two --> 
<!-- SCROLL TOP BUTTON --> 
          ...
          <div class="aa-header-top-area"> 
            ...
            <div class="aa-header-top-left"> 
              ...
              <div class="cellphone hidden-xs">
                <p><span class="fa fa-phone"></span>9023550700</p>
              </div>
              <!-- / cellphone --> 
            </div>
            <!-- / header top left -->
        ...
        <div class="aa-support-area"> 
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="aa-support-single"> <span class="fa fa-truck"></span>
              <h4>FREE SHIPPING</h4>
              <P>Item Will Shipped IN Quick Response</P>
            </div>
          </div>
          <!-- single support -->
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="aa-support-single"> <span class="fa fa-clock-o"></span>
              ...
              <P>Money Will Refude within 30 days of your Purchase</P>
            </div>
          </div>
          <!-- single support -->
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="aa-support-single"> <span class="fa fa-phone"></span>
              <h4>SUPPORT 24/7</h4>
              <P>We Are 24/7 available to help you</P>
            </div>
          </div>
        </div>
      </div>
          ...
          <ul class="aa-testimonial-slider">
            ...
            <li>
              <div class="aa-testimonial-single"> <img class="aa-testimonial-img" src="img/testimonial-img-2.jpg" alt="testimonial img"> <span class="fa fa-quote-left aa-testimonial-quote"></span>
                ...
                <div class="aa-testimonial-info">
                  <p>Mayank</p>
                  <span>Owner</span> <a href="#">LinkedIN.com</a> </div>
              </div>
            </li>
            <!-- single slide -->
            <li>
            ...
            <li>
              <div class="aa-testimonial-single"> <img class="aa-testimonial-img" src="img/testimonial-img-3.jpg" alt="testimonial img"> <span class="fa fa-quote-left aa-testimonial-quote"></span>
                <p>Customers Were Satisfied by our Products and Claimed that we also have the Best Service Delivery</p>
                <div class="aa-testimonial-info">
                  <p>Amaan</p>
                  <span>COO</span> <a href="#">Solution</a> </div>
              </div>
            </li>
          </ul>
        </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <p> GSFC University</p>
                    <p><span class="fa fa-phone"></span>9023550700</p>
                    <p><span class="fa fa-envelope"></span>mayank11gujar@gmail.com</p>
                    </address>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="https://www.linkedin.com/in/mayank-gujar-b77193330/">Mayank Gujar, Armaan, Amaan</a></p>
